      ...
      <div className="sidebar-menu-dashboard">
        <div className="menu-box">
          <ul className="box-menu-dashboard">
            ...
            >
              <Link className="nav-menu-link" href={`/admin-dashboard/dashboard`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin-dashboard/my-profile`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li
              className={`nav-menu-item ${
                pathname == "/admin-dashboard/owners" ? "active" : ""
              } `}
            >
              <Link className="nav-menu-link" href={`/admin-dashboard/owners`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            >
              <Link className="nav-menu-link" href={`/admin-dashboard/companies`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
