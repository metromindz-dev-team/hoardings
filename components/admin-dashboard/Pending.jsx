  ...
  const fetchOwners = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/users/pending`,
        {
          headers: {
      ...
      <div className="main-content w-100">
        <div className="main-content-inner wrap-dashboard-content">
          ...
          <div className="widget-box-2 wd-listing mt-20">
            <h3 className="title">Pending Owners</h3>
                        ...
                        <td colSpan="4" style={{ textAlign: "center", padding: "40px 20px" }}>
                          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
                            <svg width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M9 11L12 14L22 4" stroke="#D1D5DB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                              <path d="M21 12V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H16" stroke="#D1D5DB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            <div>
                              <h4 style={{ color: "#6B7280", marginBottom: "8px", fontSize: "18px", fontWeight: "600" }}>No Pending Requests</h4>
                              <p style={{ color: "#9CA3AF", fontSize: "14px", margin: 0 }}>There are no pending owner requests at the moment.</p>
                            </div>
                          </div>
                        </td>
                      </tr>
