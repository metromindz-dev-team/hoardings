            ...
            <div className="box-contact">
              <div className="heading-section mb-48">
                <h2 className="title split-text split-lines-transform">
                  Connecting Advertisers with the Right Hoarding Spaces.
                </h2>
                
                <p className="text-1">
                  One platform for booking hoardings and listing spaces, built for both advertisers and providers.
                </p>
              </div>
              ...
              <ul className="list-info">
                <li>
                  ...
                  <div className="content">
                    ...
                    <p>#56 Metronindz Pvt. Ltd. G Block, Sahakar Nagar, Bengaluru 560092</p>
                  </div>
                </li>
          ...
          <div className="col-md-6">
            <div className="image-wrap">
              <Image
                ...
                width={550}
                height={560}
                src="/images/section/contact-page.webp"
              />
            </div>
          </div>
        </div>
