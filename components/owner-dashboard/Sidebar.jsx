          ...
          <ul className="box-menu-dashboard">
            <li
              className={`nav-menu-item ${
                pathname == "/owner-dashboard/dashboard" ? "active" : ""
              } `}
            >
              <Link className="nav-menu-link" href={`/owner-dashboard/dashboard`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li
              className={`nav-menu-item ${
                pathname == "/owner-dashboard/my-profile" ? "active" : ""
              } `}
            >
              <Link className="nav-menu-link" href={`/owner-dashboard/my-profile`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li
              className={`nav-menu-item ${
                pathname == "/owner-dashboard/my-property" ? "active" : ""
              } `}
            >
              <Link className="nav-menu-link" href={`/owner-dashboard/my-property`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li className={`nav-menu-item `}>
              <button className="nav-menu-link w-full text-left bg-none" onClick={handleLogout}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
