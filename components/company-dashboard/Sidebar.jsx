          ...
          <ul className="box-menu-dashboard">
            <li
              className={`nav-menu-item ${
                pathname == "/company-dashboard/dashboard" ? "active" : ""
              } `}
            >
              <Link className="nav-menu-link" href={`/company-dashboard/dashboard`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li
              className={`nav-menu-item ${
                pathname == "/company-dashboard/my-profile" ? "active" : ""
              } `}
            >
              <Link className="nav-menu-link" href={`/company-dashboard/my-profile`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li
              className={`nav-menu-item ${
                pathname == "/company-dashboard/my-property" ? "active" : ""
              } `}
            >
              <Link className="nav-menu-link" href={`/company-dashboard/my-property`}>
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
            ...
            <li className={`nav-menu-item `}>
              <button className="nav-menu-link w-full text-left" onClick={handleLogout}  >
                <svg
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
