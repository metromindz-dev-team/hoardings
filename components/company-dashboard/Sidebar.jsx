...
export default function Sidebar() {
  ...
  const handleLogout = async () => {
    ...
    try {
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/company/logout`,
        {},
        { withCredentials: true }
      );

      // Force redirect after successful logout
          ...
          <ul className="box-menu-dashboard">
            ...
            >
              <Link
                ...
                href={`/company-dashboard/dashboard`}
              >
                <svg
                  width={20}
                  height={20}
            ...
            >
              <Link
                className="nav-menu-link"
                href={`/company-dashboard/my-profile`}
              >
                <svg
                  width={20}
                  height={20}
            ...
            >
              <Link
                className="nav-menu-link"
                href={`/company-dashboard/my-property`}
              >
                <svg
                  width={20}
                  height={20}
